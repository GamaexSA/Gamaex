...
export default async function CambioEuroChilePage() {
  ...
  return (
    <>
      ...
      <LandingPage rates={data.rates} systemStatus={data.system_status} lastSyncAt={data.last_sync_at} pageContext={{ h1Before: "Cambio de euro en ", h1Accent: "Chile", heroDesc: "Compra y venta de euros en Chile al mejor precio. Gamaex en Providencia — cotización EUR/CLP actualizada, sin comisiones." }} />
    </>
  );
}
