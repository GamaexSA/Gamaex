...
export default async function PrecioDolarHoyProvidenciaPage() {
  ...
  return (
    <>
      ...
      <LandingPage rates={data.rates} systemStatus={data.system_status} lastSyncAt={data.last_sync_at} pageContext={{ h1Before: "Precio del dólar hoy en ", h1Accent: "Providencia", heroDesc: "Precio del dólar actualizado hoy en Providencia. Gamaex en Av. Pedro de Valdivia 020 — cotización USD/CLP en tiempo real." }} />
    </>
  );
}
