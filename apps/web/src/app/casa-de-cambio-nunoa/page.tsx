...
export default async function CasaDeCambioNunoaPage() {
  ...
  return (
    <>
      ...
      <LandingPage rates={data.rates} systemStatus={data.system_status} lastSyncAt={data.last_sync_at} pageContext={{ h1Before: "Casa de cambio cercana a ", h1Accent: "Ñuñoa", heroDesc: "Casa de cambio a minutos de Ñuñoa. Gamaex en Av. Pedro de Valdivia 020, Providencia — USD, EUR y +40 divisas sin comisiones." }} />
    </>
  );
}
